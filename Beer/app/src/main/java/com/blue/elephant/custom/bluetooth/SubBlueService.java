...
public class SubBlueService extends Service {

    private final String TAG  = "SubBlueService";
    ...
    private BluetoothAdapter.LeScanCallback mScanConnectCallback= new BluetoothAdapter.LeScanCallback() {
        ...
        public void onLeScan(final BluetoothDevice device, int rssi, byte[] scanRecord) {
            ...
            if(name.equals(mDeviceName)) // 连接设备
            {
                ...
                mBluetoothGatt = mBluetoothDevice.connectGatt(SubBlueService.this,false,mBluetoothGattCallback);//连接当前的设备,初始化蓝牙Gatt 对象
...
//                        preQueue.remove(mBleRuest);
    ...
    public class BleBinder extends Binder {
        ...
        public SubBlueService getService()
        {
            return SubBlueService.this;
        }
    }
