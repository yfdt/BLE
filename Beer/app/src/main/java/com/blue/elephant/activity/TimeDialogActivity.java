...
public class TimeDialogActivity extends Activity {
    ...
    private SimpleDateFormat mSimpleDate = new SimpleDateFormat("yyyy-MM-dd");
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                try {
                    ...
                    if (start.equals(income_s_tip)) {
                        DialogUtils.showToast(TimeDialogActivity.this,R.string.income_menu_start_t);
                        return;
                    }
                    if (end.equals(income_e_tip)) {
                        DialogUtils.showToast(TimeDialogActivity.this,R.string.income_menu_end_t);
                        return;
                    }
                    DateFormat dfday = new SimpleDateFormat("yyyy-MM-dd");
                    try {
                        long mStartMillins = dfday.parse(start).getTime();
                        long mEndMillins = dfday.parse(end).getTime();
                        if (mStartMillins > mEndMillins) {
                            DialogUtils.showToast(TimeDialogActivity.this,R.string.income_menu_time_before);
                            return;
                        }
                    } catch (Exception e) {
                        tvStart.setText(R.string.income_menu_start);
                        tvEnd.setText(R.string.income_menu_end);
                        DialogUtils.showToast(TimeDialogActivity.this,R.string.income_menu_time_error);
                    }
        ...
        tvStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerView mView = new TimePickerView(TimeDialogActivity.this);
                mView.setHour();
