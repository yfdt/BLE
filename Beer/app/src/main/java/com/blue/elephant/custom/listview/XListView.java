package com.blue.elephant.custom.listview;
...
public class XListView extends ListView  implements AbsListView.OnScrollListener {
    ...
    private void initWithContext(Context context) {
        ...
        // user's listener (as IApplication proxy).
        ...
        switch (ev.getAction()) {
			...
			/*System.out.println("数据监测：" + getFirstVisiblePosition() + "---->"
                ...
                if (getFirstVisiblePosition() == 0
                        && (mHeaderView.getVisiableHeight() > 0 || (deltaY > 0 && absY > absX))) {
                    // the first item is showing, header has shown or pull down.
                    updateHeaderHeight(deltaY / OFFSET_RADIO);
                    invokeOnScrolling();
                } else if (getLastVisiblePosition() == mTotalItemCount - 1
                        && (mFooterView.getBottomMargin() > 0 || (deltaY < 0 && absY > absX))) {
