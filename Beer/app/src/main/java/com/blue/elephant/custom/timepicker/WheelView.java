...
//    private int itemsVisible = 11;
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        else
        {
            ...
            textColorOut =context.getResources().getColor(R.color.picker_text_out);
            textColorCenter = context.getResources().getColor(R.color.picker_text_center);
            dividerColor = context.getResources().getColor(R.color.picker_divider);
            textSize = (int) context.getResources().getDimension(R.dimen.picker_text_size);
            lineSpacingMultiplier = 1.6F;
        }

//        judgeLineSpace();
        lineSpacingMultiplier = context.getResources().getDimension(R.dimen.picker_space);
