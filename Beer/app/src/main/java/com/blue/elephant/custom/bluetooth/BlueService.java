...
public class BlueService extends Service {
    ...
    private BluetoothAdapter.LeScanCallback mScanConnectCallback= new BluetoothAdapter.LeScanCallback() {
        ...
        public void onLeScan(final BluetoothDevice device, int rssi, byte[] scanRecord) {
            ...
            if(name.equals(mDeviceName)) // 连接设备
            {
                ...
                mBluetoothGatt = mBluetoothDevice.connectGatt(BlueService.this,false,mBluetoothGattCallback);//连接当前的设备,初始化蓝牙Gatt 对象
    ...
    public final static String SET_LOCK="AT+GuardStatus=1";
    public final static String SET_UNLOCK="AT+GuardStatus=0";
    public final static String GET_DEADLINE="AT+DeadLine=?";
    public final static String GET_DEVICE_INFO="AT+DevInfo=?";
    public final static String GET_ERROR_STATUS="AT+ErrorStatus=?";
    public final static String GET_MILEAGE="AT+Mileage=?";
    public final static String GET_VERSION="AT+HardwareVersion=?";
    public final static String GET_ELECTLOCK="AT+ElectLock=?";
    public final static String BLE_CONNECT = "BeerbikeV1";
    ...
    private BlueService.ImageA image = new BlueService.ImageA();
...
//                        preQueue.remove(mBleRuest);
    ...
    private BlueService.BleBinder mBinder = new BlueService.BleBinder();
...
//                        setNotificationForCharacteristic(gattCharacteristic, true);
    ...
    public void showEmptyDevice(View view, final BlueService.onCancelListener onListener)
    {
        if(mPopWindow != null)
            mPopWindow = null;
